    ...
    <section className="converter">
      ...
      <form className="converter__form">
        ...
        <div className="converter__wrapper">
          <label for="i-have" class="converter__name-input" title="i-have">У меня есть</label>
        ...
        <div className="converter__wrapper">
          <label for="i-want-to-buy" className="converter__name-input" title="i-want-to-buy">Хочу приобрести</label>
        ...
        <div className="converter__submit-wrapper">
          ...
          <button className="converter__button"></button>
        </div>
      </form>
    </section>
      ...
      <section className="footer-description">
        ...
        <div className="footer-description__wrapper">
          <div className="adress">
            <!-- SVG -->
            <p class="adress__text">150015, г. Москва, ул. Московская, д. 32
          ...
          <div className="mobile">
            ...
            <p className="mobile-description">Бесплатно для абонентов МТС, Билайн, Мегафон, Теле2</p>
          </div>
