...
import { getLoadConvers } from "../store/api-actions";

console.log(getLoadConvers());
const MainComponent = () => {
  return (
    <>
              ...
              <section className="converter">
                ...
                <form className="converter__form">
                    ...
                    <div className="converter__case">
                      <div className="converter__position">
                        ...
                        <div className="converter__wrapper">
                          <input className="converter__value" name="give" type="text" id="i-have" placeholder="1000"/>
                      ...
                      <div className="converter__position">
                        ...
                        <div className="converter__wrapper">
                            <input className="converter__value" type="text" id="i-want-to-buy" placeholder="1004" />
                            <select className="converter__list">
                              <option className="converter__item">USD</option>
                              <option className="converter__item">RUB</option>
                              <option className="converter__item">EUR</option>
                  ...
                  <div className="converter__submit-wrapper">
                    <input className="converter__value converter__date" type="date" placeholder="1.12.2021" />
                    <button className="converter__button">Сохранить результат</button>
                  </div>
                </form>
              </section>
                  ...
                  <div className="history__converter">
                    <ul className="history__list">
                      <li className="history__item">
                        <span className="history__text">25.11.2020</span>
                        <span className="history__text">1000 RUB</span>
                        <span className="history__text">13,1234 USD</span>
                      </li>
                      <li className="history__item">
                        <span className="history__text">25.11.2020</span>
                        <span className="history__text">1000 RUB</span>
